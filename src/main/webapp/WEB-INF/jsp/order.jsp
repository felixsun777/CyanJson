											...
											<tr class="odd gradeX">
												...
												<td align="center">
													<button type="button" class="btn btn-success"
														onclick="location='${pageContext.request.contextPath}/order/modify?orderId=${c.orderId}&userId=${c.userId}&orderStatus=${c.orderStatus}&orderSum=${c.orderSum}'"
														style="width: 80px">Status</button>
													<button type="button" class="btn btn-info"
														onclick="location='${pageContext.request.contextPath}/order/detail?orderId=${c.orderId}&userId=${c.userId}&orderStatus=${c.orderStatus}&orderSum=${c.orderSum}&receiverName=${c.receiverName}&phone=${c.phone}&email=${c.email}&address=${c.address}&state=${c.state}&city=${c.city}&zip=${c.zip}'"
